...
export default () => (
	...
	<a href="/" onClick={(e) => e.preventDefault()} className="ng-footer-contact-button drift-open-chat">
	...
	<div className="ng-footer-inner">
		<div className="ng-footer-box ng-footer-left-box">
				...
				<a href="https://www.linkedin.com/company/nextgen-code-company" target="_blank" rel="noopener noreferrer" className="ng-footer-social-icon">
								...
								<br />
									<br />
										<i>"We help our partners leverage technology to improve business and advance our world into the next century."</i>
								</div>
									<div className="ng-footer-box ng-footer-center-box">
										...
										<br />
											{/*<a href="/careers"className="ng-footer-hiring-button">
												WE ARE HIRING
											</a>*/}
										</div>
										<div className="ng-footer-box ng-footer-right-box">
											© 2018 NEXTGEN Code Company<br /><br />3911 4th St.<br />Suite 114<br />Lubbock, TX 79415
										</div>
									</div>
